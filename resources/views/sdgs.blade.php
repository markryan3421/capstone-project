    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-10 p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
      <div class="flex items-center gap-4 mb-4 md:mb-0">
        ...
        <div class="text-center group">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-md hover:border-blue-200 dark:hover:border-blue-800">
                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-1">
                    {{ $sdgs->count() }}
                </div>
                <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Active SDGs</div>
        ...
        <!-- Goals Card -->
        <div class="text-center group">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-md hover:border-green-200 dark:hover:border-green-800">
                <div class="text-2xl font-bold text-green-600 dark:text-green-400 mb-1">
                    {{ $totalGoals }}
                </div>
                <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Active Goals</div>
                <div class="flex justify-center mt-2">
        ...
        <!-- Tasks Card -->
        <div class="text-center group">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-md hover:border-orange-200 dark:hover:border-orange-800">
                <div class="text-2xl font-bold text-orange-600 dark:text-orange-400 mb-1">
                    {{ $totalTasks }}
                </div>
                <div class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Active Tasks</div>
                <div class="flex justify-center mt-2">
                    <div class="w-6 h-1 bg-orange-500 rounded-full"></div>
                </div>
            </div>
        </div>
    </div>
