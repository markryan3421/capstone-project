<x-sdg>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-16 mx-auto">
    ...
    <div class="mb-8">
      ...
      <div class="flex items-center gap-3 mb-2">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add New SDG</h1>
      </div>
      <p class="text-lg text-gray-600 dark:text-gray-400 ml-11">
        Create a new Sustainable Development Goal to add to your dashboard
      </p>
    </div>
      ...
      <div class="space-y-6">
        <div class="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div class="group relative flex flex-col w-full min-h-80 bg-center bg-cover rounded-xl overflow-hidden border border-gray-300 dark:border-gray-600 shadow-md"
               style="background-image: url('https://preline.co/assets/img/160x160/img1.jpg');" 
               id="preview-card">
          ...
          <div class="space-y-6">
                ...
                <div class="text-center">
                  <div class="relative inline-block">
                    <img 
                      ...
                      id="avatar-preview"
                    >
                    <div class="absolute -bottom-2 -right-2 bg-emerald-500 text-white p-1.5 rounded-full shadow-lg">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                  </div>
                  <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Preview</p>
                </div>
            ...
            <div class="space-y-4">
              ...
              <div class="flex justify-between items-center text-xs text-gray-500 dark:text-gray-400 mt-2">
                ...
                <span id="char-count" class="font-mono">0/120</span>
              </div>
            </div>
  ...
  <script>
    ...
    function updatePreview() {
      ...
      previewName.textContent = nameInput.value || 'New SDG';
