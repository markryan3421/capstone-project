<x-layout class="bg-gray-900/50 min-h-screen backdrop-blur-sm">
  <div class="max-w-2xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="bg-gray-800/70 backdrop-blur-lg shadow-xl rounded-xl p-8 border border-gray-700/30">
      <h2 class="text-2xl font-bold text-white mb-6">Submit Task: {{ $task->title }}</h2>

      <form method="POST" action="{{ route('tasks.submit', $task->slug) }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
