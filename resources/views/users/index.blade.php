<x-settings>
    <div class="py-8">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <!-- Flash Messages -->
            @if(session('success'))
                <div class="p-4 mb-6 text-green-800 bg-green-100 border-l-4 border-green-500 rounded-md">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-green-500" viewBox="0 0 20 20" fill="currentColor">
            ...
            @if(session('error'))
                <div class="p-4 mb-6 text-red-800 bg-red-100 border-l-4 border-red-500 rounded-md">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 text-red-500" viewBox="0 0 20 20" fill="currentColor">
