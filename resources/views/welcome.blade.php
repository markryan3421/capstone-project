...
<body class="bg-gray-900 text-gray-100 font-['Inter']">
  ...
  <div id="splashScreen" class="splash-screen">
    <div class="text-center">
      <div class="logo-animation mb-6">
        <div class="w-24 h-24 bg-gradient-to-br from-blue-600 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
          <img src="{{ asset('images/logo1.png') }}" alt="SDG Logo" class="w-16 h-16 object-contain">
        </div>
      </div>
      <h1 class="text-3xl font-bold text-white mb-2">SDG Portal</h1>
      <p class="text-gray-300">Sustainable Development Goals</p>
    </div>
  </div>
  ...
  <div id="mainContent" class="relative">
    ...
    <!-- Main Wrapper -->
    <div class="main-wrapper relative z-10 no-flash">
      <!-- Content Area -->
            ...
            <div class="lg:w-1/2 space-y-8 flex flex-col items-center lg:items-center relative">
              ...
              <div class="relative w-52 h-52 mb-8">
                ...
                <img src="{{ asset('images/logo1.png') }}" alt="SDG Logo"
                     class="w-full h-full object-contain animate-subtle-float opacity-90">
              </div>
      ...
      <!-- Compact Footer -->
      <footer class="py-4 border-t border-gray-800/50 bg-gray-900/80 backdrop-blur-sm">
        <div class="container mx-auto px-4">
          <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex gap-4">
              <a href="{{ route('about') }}" class="text-gray-400 hover:text-blue-400 smooth-transition text-xs">About</a>
              <a href="{{ route('terms') }}" class="text-gray-400 hover:text-blue-400 smooth-transition text-xs">Terms</a>
              <a href="{{ route('privacy') }}" class="text-gray-400 hover:text-blue-400 smooth-transition text-xs">Privacy</a>
              <a href="{{ route('contact') }}" class="text-gray-400 hover:text-blue-400 smooth-transition text-xs">Contact</a>
            </div>
          </div>
        </div>
      </footer>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Show splash screen for 1.5 seconds then transition to main content
      setTimeout(() => {
        // Add fade-out animation to splash screen
        splashScreen.classList.add('animate-fade-out');

        // After fade-out animation completes, show main content with fade-in
        setTimeout(() => {
