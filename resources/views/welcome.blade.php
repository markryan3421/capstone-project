...
<body class="bg-gray-900 text-gray-100 font-['Inter'] overflow-hidden">
  <!-- Splash Screen -->
  <div id="splashScreen" class="splash-screen">
    <div class="text-center">
      ...
      <h1 class="text-3xl font-bold text-white mb-2 animate-scale-up">SDG Portal</h1>
      <p class="text-gray-300 animate-slide-up">Sustainable Development Goals</p>
    </div>
  </div>

  <!-- Main Content (Initially Hidden) -->
  <div id="mainContent" class="relative hidden">
    <!-- Particle Background -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          mainContent.classList.add('animate-scale-up');
          
          // Initialize particles after main content is shown
